...
## 株式会社SephirothicSystem (2025-01-01 ~ 現在)
  ...
  - 主に自社サービスの開発を自分一人で行っている
    - リリースしたもの
      - [League Mentor](https://league-mentor.break-price.net/)
        - League of Legendsに特化したコーチング支援サービス
        - AWS, Python(Django), TypeScript(Next.js)で開発
        - 決済管理、スケジュール管理、GoogleCalendar, Discord,X,RiotAccount連携などの機能がある
      - [Coachify](https://coachify.jp/)
        - コーチング、オンラインサロン運営、メルマガ配信すべてが１つとなったオールインワンSaaS
        - AWS, Python(Django), TypeScript(Next.js)で開発
        - サイト内に掲載してあるような機能が盛り込まれている
      - [Novelfy](https://novelfy.net/)
        - AI短編小説作成・公開サービス
        - AWS, Python(Django), TypeScript(Next.js)で開発
        - 3日程度で作った実験的なアプリ。
        - 地味にCDNやキャッシュを駆使してパフォーマンスを向上させている。
    - 直近リリース予定のサービス
      - AIショート動画生成サービス(２０２５年８月中にリリース予定)
        - テキストやPDFから、30秒~3分程度の動画を自動生成できるサービス
      - AI小説執筆サービス(２０２５年７月中にリリース予定)
        - 前述したNovelfyとは完全に別物で、登場人物や用語、チャプターなど、細かく設定できたり、ブラウザ上でリッチテキストエディターで実際に小説を書きながら、AIに支援してもらい、長編小説を執筆可能なサービス
      - ナレッジ共有サイトホスティング&AIチャット提供サービス
        - Notionのようにリッチテキストエディターでテキストでいろいろな情報をナレッジとして管理できるアプリケーションで、さらにそのデータのベクトルデータとして保存することにより、そのナレッジ保有者が、そのナレッジを利用したAIチャットアプリを有料で販売できるサービス
        - 直近、弊社がesports事業に参入予定でゲームの解説サイトを作る必要が出てきたので、そのためにこのようななサービスが必要になった。どうせなら、SaaSとして開発して、販売して自分もその利用者の一人として使うようにしたほうが得だと思い、開発中である。
  - その他過去に関わりのあった企業のお手伝い
    - 前所属していた会社への技術的なアドバイス
      - 基本的に関わった企業とSlackConnectでつながっており、たまに相談に乗ったりしている
    - 生成AI関連の実装のアドバイス
      - 使用するライブラリやエージェントの実装手法など、自社で培ったナレッジをもとにアドバイスしたりしている。
...
## 個人事業主（フリーランスエンジニア）(2021-10 ~ 2023-12-31)
  ...
  - [物流倉庫管理のマルチテナントサービスの開発](#物流倉庫管理のマルチテナントサービスの開発)(3ヶ月、2023-10 ~ 2023-12)
  - [美容整形の予約・口コミ投稿サービス](#美容整形の予約・口コミ投稿サービス)(2年以上、2021-10 ~ 2023-09)
  - [金融機関向けローン申込サービス](#金融機関向けローン申込サービス)(2ヶ月、2021-01 ~ 2021-02)
  - [不動産営業支援・賃貸物件検索サービスの開発](#不動産営業支援・賃貸物件検索サービスの開発)(5ヶ月、2022-03 ~ 2022-07)
  - [不動産電子契約システムの開発支援](#不動産電子契約システムの開発支援)(8ヶ月、2021-12 ~ 2022-07)
