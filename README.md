...
| -------- | ---------------------------------------------------------------------------------------------------------- |
| 氏名     | 佐藤慎吾                                                                                                   |
| 業務形態 | 正社員 [株式会社Hubble在籍](https://hubble-docs.com/about)                                                                        |
| 年齢     | 26                                                                                                         |
| 性別     | 男性                                                                                                       |
| 最寄り   | 札幌地下鉄                                                                                                 |
| 最終学歴 | 高卒(大学中退)                                                                                             |
...
## 石狩南高等学校 卒業(2016-03)
## 北海学園大学 中退(2016-04 ~ 2017-03)
## フリーター(2017-04 ~ 2019-03)
ガソリンスタンドでバイトしたり、ネカフェでバイトしたりしてた気がするけど、
もうあんま覚えてない。
## バルテック株式会社(2019-04)
ブラックなSESだったため、試用期間で退職
## 株式会社ウィナス(2019-9 ~ 2020-09)
  - [ラベル管理アプリケーションへの機能追加案件](#ラベル管理アプリケーションへの機能追加案件)(3 Month)
  - [旅行情報サイトのリニューアル](#旅行情報サイトのリニューアル)(5 Month)
  - [ゲームのAPIサーバーの開発](#ゲームのAPIサーバーの開発)(5 Month)
## Intloop株式会社(2020-10 ~ 2021~01)
  - [フリーランス向けの営業支援システムの開発_運用](#フリーランス向けの営業支援システムの開発_運用)(4 Month)
## 個人事業主(2021-01 ~ 2021-06)
  - [不動産電子契約システムの新規開発](#不動産電子契約システムの新規開発)(6 Month)
## リアルグローブオートメイティッド(2021-07 ~ 2021-09)
  - [工場作業者向けの生産管理システムの開発](#工場作業者向けの生産管理システムの開発)(3 Month)
## 個人事業主(フリーランスエンジニア)(2021-10 ~ 2023-12-31)
  - [不動産電子契約システムの開発補助](#不動産電子契約システムの開発補助)(8 Month)
  - [不動産営業支援_賃貸マンション検索サービスの開発](#不動産営業支援_賃貸マンション検索サービスの開発)(5 Month)
  - [金融関係のローン申請サービス](#金融関係のローン申請サービス)(2 Month)
  - [美容整形の施術予約_口コミ投稿サービス](#美容整形の施術予約_口コミ投稿サービス)(2 years over)
  - [物流倉庫の管理マルチテナントサービスの開発](#物流倉庫の管理マルチテナントサービスの開発) -> (3 month)

## 株式会社Hubble(2024-01-01 ~ now)

  - [契約書関連サービスでフルスタックに開発](#契約書関連サービスでフルスタックに開発)
...
- Datadog周りの監視基盤の整備
  ...
  - 各種APIのレイテンシーを常に監視し、速度が遅いものは、自動でタスク化されるような仕組みも構築
- CICDの速度チューニング
  - テストにすごい時間がかかっていたので、そこの速度改善をしました。実際に、8分程度かかっていたのが、4分程度になりました。
